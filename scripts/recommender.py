...
def get_top_n_recommendations(algo: Any, opt_data: Tuple[Dict[str, Set[str]], Set[str]], maps: Tuple[Dict[str, str], Dict[str, str]], user_id: int, n: int = 10) -> pd.DataFrame:
    """
    Gera as Top-N Recomendações de forma otimizada.
    """
